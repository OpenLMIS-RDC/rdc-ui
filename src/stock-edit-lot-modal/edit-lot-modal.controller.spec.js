...
describe('EditLotModalController', function() {
    ...
    describe('updateItem', function() {
        ...
        it('should assign values from newLot to selectedItem', function() {
            ...
            that.vm.newLot.manufactureDate = new Date() - 1;
            ...
            expect(that.selectedItem.lot.manufactureDate).toEqual(that.vm.newLot.manufactureDate);
        });
    });
    ...
    describe('validate', function() {
        ...
        it('should assign error message when manufactureDate equals current date', function() {
            that.vm.newLot.manufactureDate = new Date();

            that.vm.updateItem();

            expect(that.vm.newLot.manufactureDateInvalid).not.toBeDefined();
        });

        it('should not assign error message when manufactureDate before current date', function() {
            that.vm.newLot.manufactureDate = '2019-09-09';
