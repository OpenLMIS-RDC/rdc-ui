...
(function() {
    ...
    function controller(selectedItem, modalDeferred, messageService, moment, allLineItems, addedLineItems) {
         ...
         * Validate if manufactureDate is a previous date.
         */
        function validateDate() {
            ...
            if (vm.newLot.expirationDate && vm.newLot.expirationDate < currentDate) {
            ...
            } else if (vm.newLot.manufactureDate && vm.newLot.manufactureDate > currentDate) {
                vm.newLot.manufactureDateInvalid = messageService
                    .get('stockEditLotModal.manufactureDateInvalid');
                ...
                vm.addedLineItems.forEach(function(lineItem) {
                    if (lineItem.$isNewItem && lineItem.orderable.productCode === vm.selectedItem.orderable.productCode
                        ...
                        if (vm.selectedItem.lot.expirationDate !== lineItem.lot.expirationDate) {
                            vm.newLot.expirationDateInvalid =
                            messageService.get('stockEditLotModal.expirationDateInvalidForLotCode');
                        } else if (vm.selectedItem.lot.manufactureDate !==
                            lineItem.lot.manufactureDate) {
                            vm.newLot.manufactureDateInvalid =
                            messageService.get('stockEditLotModal.manufactureDateInvalidForLotCode');
                        }
                    }
                });
            }
         ...
         * @ngdoc method
         * @methodOf stock-edit-lot-modal.controller:EditLotModalController
         * @name manufactureDateChanged
         *
         * @description
         * Hides the error message if exists after changed manufacture date.
         */
