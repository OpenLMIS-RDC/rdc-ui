...
(function() {
    ...
    function controller($scope, $state, $stateParams, $filter, confirmDiscardService, program,
         ...
         * @ngdoc method
         * @methodOf stock-adjustment-creation.controller:StockAdjustmentCreationController
         * @name validateManufactureDate
         *
         * @description
         * Validate if manufactureDate is a past date.
         */
        function validateManufactureDate() {
            var currentDate = moment(new Date()).format('YYYY-MM-DD');

            if (vm.newLot.manufactureDate && vm.newLot.manufactureDate > currentDate) {
                vm.newLot.manufactureDateInvalid = messageService.get('stockEditLotModal.manufactureDateInvalid');
            }
        }
