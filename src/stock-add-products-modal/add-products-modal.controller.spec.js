...
describe('AddProductsModalController', function() {
    ...
    describe('addOneProduct', function() {
        ...
        it('should NOT add if manufactureDate is invalid', function() {
            item1.lot.manufactureDate = new Date() + 1;
            vm.addOneProduct();
        ...
        it('should add if missing lot provided', function() {
            ...
            var newLot = {
                ...
                manufactureDate: vm.newLot.manufactureDate,
    ...
    describe('orderableSelectionChanged', function() {
        ...
        it('should clear new lot manufacture date', function() {
            vm.newLot.manufactureDate = new Date() + 1;
            vm.orderableSelectionChanged();

            expect(vm.newLot.manufactureDate).not.toBeDefined();
        });
